...
cmd.exe --% /c wget -nv --no-check-certificate https://storage.googleapis.com/natcap-build-dependencies/windows/Inetc.zip
cmd.exe --% /c wget -nv --no-check-certificate https://storage.googleapis.com/natcap-build-dependencies/windows/Nsisunz.zip
cmd.exe --% /c wget -nv --no-check-certificate https://storage.googleapis.com/natcap-build-dependencies/windows/NsProcess.zip
