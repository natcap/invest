...
Section "InVEST Tools and ArcGIS toolbox" Section_InVEST_Tools
  ...
  CreateShortCut "${SMPATH}\Forest Carbon Edge Effect (${ARCHITECTURE}).lnk" "${INVEST_DATA}\invest_carbon_edge_effect.bat" "" "${INVEST_ICON}"
...
SectionGroup /e "InVEST Datasets" SEC_DATA
  ...
  SectionGroup "Terrestrial Datasets" SEC_TERRESTRIAL_DATA
    ...
    !insertmacro downloadData "Carbon Edge Effects (required for carbon edge model)" "carbon_edge_effect.zip" 8270
