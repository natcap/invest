...
MAC_BINARIES_ZIP_FILE := "$(DIST_DIR)/InVEST-$(VERSION).zip"
...
$(MAC_BINARIES_ZIP_FILE): $(DIST_DIR) $(INVEST_BINARIES_DIR) $(USERGUIDE_HTML_DIR)
	./installer/darwin/build_zip.sh "$(VERSION)" "$(INVEST_BINARIES_DIR)" "$(USERGUIDE_HTML_DIR)"
