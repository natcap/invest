...
GIT_SAMPLE_DATA_REPO_REV   := 950ad26cf4c8ab839e59947a7164e7017d4e8afb

GIT_TEST_DATA_REPO         := https://bitbucket.org/natcap/invest-test-data.git
GIT_TEST_DATA_REPO_PATH    := $(DATA_DIR)/invest-test-data
GIT_TEST_DATA_REPO_REV     := 0ffe72bd4c675f8fff5b5c735ce4a32654a220c2
...
$(GIT_SAMPLE_DATA_REPO_PATH): | $(DATA_DIR)
	-git clone $(GIT_SAMPLE_DATA_REPO) -n $(GIT_SAMPLE_DATA_REPO_PATH)
	git -C $(GIT_SAMPLE_DATA_REPO_PATH) checkout $(GIT_SAMPLE_DATA_REPO_REV)

$(GIT_TEST_DATA_REPO_PATH): | $(DATA_DIR)
	-git clone $(GIT_TEST_DATA_REPO) -n $(GIT_TEST_DATA_REPO_PATH)
