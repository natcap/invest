...
GIT_SAMPLE_DATA_REPO_REV    := 598664165b911186e16a987c556f56f993cc78dd
...
GIT_UG_REPO_REV              := d209a08683c06d6b00cdb69ddb9d9e5bb28f2eab
...
$(USERGUIDE_TARGET_DIR): $(GIT_UG_REPO_PATH) $(GIT_SAMPLE_DATA_REPO_PATH) | $(DIST_DIR)
	...
	cmd "/c mklink /d invest-sample-data $(WORKING_DIR)/data/invest-sample-data"
