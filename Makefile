...
GIT_SAMPLE_DATA_REPO_REV    := 57ef2ec4302b68a717cf3c7d4014ea0e82f613e4
...
$(GIT_SAMPLE_DATA_REPO_PATH): | $(DATA_DIR)
	-GIT_LFS_SKIP_SMUDGE=1 git clone $(GIT_SAMPLE_DATA_REPO) $(GIT_SAMPLE_DATA_REPO_PATH)
	GIT_LFS_SKIP_SMUDGE=0 git -C $(GIT_SAMPLE_DATA_REPO_PATH) checkout $(GIT_SAMPLE_DATA_REPO_REV)

$(GIT_TEST_DATA_REPO_PATH): | $(DATA_DIR)
	-GIT_LFS_SKIP_SMUDGE=1 git clone $(GIT_TEST_DATA_REPO) $(GIT_TEST_DATA_REPO_PATH)
	GIT_LFS_SKIP_SMUDGE=0 git -C $(GIT_TEST_DATA_REPO_PATH) checkout $(GIT_TEST_DATA_REPO_REV)
