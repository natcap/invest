...
args = {
    'aoi_vector_path': f'{SAMPLEDATA}\\subregions.shp',
    'criteria_table_path': f'{SAMPLEDATA}\\exposure_consequence_criteria.csv',
    'decay_eq': 'Linear',
    'info_table_path': f'{SAMPLEDATA}\\habitat_stressor_info.csv',
    'max_rating': '3',
    'resolution': '500',
    'results_suffix': '',
    'risk_eq': 'Euclidean',
