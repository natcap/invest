...
* Additional data attributes (data type, projection requirements, and
  whether an input has the default target projection or pixel size) will
  now automatically be added to spatial inputs listed in the Data Needs
  sections of the User's Guide.
  (`#2749 <https://github.com/natcap/invest/issues/2749>`_)
