...
def report(file_registry, args_dict, model_spec, target_html_filepath,
    ...
    Args:
        ...
        target_html_filepath (str): path to an HTML file to be generated by
            this function.
        input_raster_plot_configs (list[raster_utils.RasterPlotConfig]):
            used to plot input rasters
        output_raster_plot_configs (list[raster_utils.RasterPlotConfig]):
            used to plot output rasters
        intermediate_raster_plot_configs (list[raster_utils.RasterPlotConfig]):
            used to plot intermediate rasters
    ...
    lulc_img_src, lulc_legend_html = raster_utils.plot_categorical_raster(
        args_dict['lulc_path'])
