...
def execute(args):
    ...
    pygeoprocessing.reproject_dataset_uri(
        file_registry['dem_below_sea_path'], args['cell_size'], aoi_wkt,
    ...
    for viewshed_file in os.listdir(viewshed_dir):
        ...
        vshed_val_path = pygeoprocessing.temporary_filename()
