...
def execute(args):
    ...
    natcap.invest.pygeoprocessing_0_3_3.create_directories([output_dir, intermediate_dir])
...
def _aggregate_carbon_map(
    ...
    if not original_serviceshed_datasource:
        raise ValueError("Unable to open aoi: %s" % aoi_uri)
