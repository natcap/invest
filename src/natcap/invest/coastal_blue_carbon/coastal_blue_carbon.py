...
def execute(args):
    ...
    :param str args['lulc_transition_matrix_uri']: generated by the preprocessor. This
    ...
    :param str args['lulc_baseline_map_uri']: a GDAL-supported raster representing
        the baseline landscape/seascape.

    :param list args['lulc_transition_maps_list']: a set of GDAL-supported rasters
        representing the landscape/seascape at particular points in time.
        Provided in chronological order.

    :param list args['lulc_transition_years_list']: a set of years that respectively
