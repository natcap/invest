    ...
    "args": {
        ...
        "guild_table_path": {
            ...
            "columns": {
                ...
                "foraging_activity_[SEASON]_index": {
                    ...
                    "type": "ratio",
                    "about": ("Pollinator activity by floral season (i.e., "
                        "flight season), with 1 indicating the season of "
                        "greatest activity for the species/guild, and 0 "
                        "indicating a season of no activity. Seasons are user "
                        "defined but might include spring, summer, fall; wet, "
                        "dry, etc. The SEASON string must match a "
                ...
                "relative_abundance": {
                    "type": "ratio",
                    "about": ("The proportion of total pollinator abundance "
                        "that consists of this species/guild. Using the same "
                        "value for each species will result in each species "
                        "being weighted equally.")
                }
            },
            "required": True,
            "about": ("A table mapping each pollinator species/guild of "
                "interest to its pollination-related parameters."),
            "name": "Guild Table"
        },
        "landcover_biophysical_table_path": {
            ...
            "about": ("A table mapping each LULC class to nesting availability "
                "and floral abundance data for each substrate and season in "
                "that LULC class."),
        ...
        "farm_vector_path": {
            ...
            "fields": {
                ...
                "season": {
                    "type": "freestyle_string",
                    "about": ("The season in which the crop is pollinated. "
                        "This season must match a season in the guild table.")},
                "fr_[SEASON]": {
                ...
                "n_[SUBSTRATE]": {
                    ...
                    "type": "ratio",
                    "about": ("The nesting substrate suitability for the farm "
                        "for the given substrate. The SUBSTRATE string must "
                        "match one of the substrates in the guild table.")},
                "p_dep": {
                    "type": "ratio",
                    "about": ("The proportion of crop dependent on "
                        "pollinators. See Klein et al. (2007) for estimates "
                        "for common crops.")},
                "p_managed": {
                    "type": "ratio",
                    "about": ("The proportion of pollination required on the "
                        "farm provided by managed pollinators. This can be "
