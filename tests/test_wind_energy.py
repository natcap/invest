...
REGRESSION_DATA = os.path.join(os.path.dirname(__file__), 'data', 'wind-energy')
...
class SuffixTest(unittest.TestCase):
    ...
    def test_regression(self):
        ...
        raster_results = ['carbon_emissions_tons_test.tif', 'density_W_per_m2_test.tif',
			'harvested_energy_MWhr_per_yr_test.tif',
			'levelized_cost_price_per_kWh_test.tif',
			'npv_US_millions_test.tif']
