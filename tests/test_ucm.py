...
def make_simple_vector(path_to_shp):
    ...
    shapely_geometry_list = [
        Polygon([(461251, 4923245-50), (461251+250, 4923245-50),
                 (461251+250, 4923245+200), (461251, 4923245+200)])
    ]
...
class UCMTests(unittest.TestCase):
    ...
    def test_cc_rasters(self):
        """Test that `execute` creates correct values with synthetic data"""
        from natcap.invest import urban_cooling_model
        ...
        # (Note: the align/resize PGP function vertically flips the input arrays above)
        ...
        expected_cc_park = numpy.array(
            [[0.125522, 0.13439381, 0.15243557, 0.17524933, 0.19330405, 0.21304217],
