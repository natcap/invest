...
# class ExecuteDecoratorTests(unittest.TestCase):
...
#         with unittest.mock.patch('natcap.invest.carbon.execute.__wrapped__',
#                                  new=unittest.mock.Mock(return_value="Mocked original function")
#                                 ) as patched_model:
#             cli.main([
#                 'run',
#                 'carbon',
